        ...
        <div className="hidden lg:flex items-center gap-8">
          ...
          <div className="flex items-center space-x-6 ml-4">
            <div className="flex space-x-5">
              <a href="https://instagram.com" className="hover:text-blue-600 hover:scale-110 transition-all text-gray-600">
                <FaInstagram className="text-xl" />
              </a>
              <a href="https://facebook.com" className="hover:text-blue-600 hover:scale-110 transition-all text-gray-600">
                <FaFacebook className="text-xl" />
              </a>
              <a href="https://linkedin.com" className="hover:text-blue-600 hover:scale-110 transition-all text-gray-600">
                <FaLinkedin className="text-xl" />
              </a>
              <a href="https://twitter.com" className="hover:text-blue-600 hover:scale-110 transition-all text-gray-600">
            ...
            <a href="tel:8390671523" className="text-gray-600 hover:text-blue-600 transition-colors font-medium">
              📞 8390671523
            </a>
          </div>
        </div>
                ...
                <div className="flex-1 overflow-y-auto">
                  ...
                  <div className="mt-8 pt-6 border-t">
                    <div className="flex space-x-6 justify-center">
                      <a href="https://instagram.com" className="hover:text-blue-600 text-gray-600">
                        <FaInstagram className="text-2xl" />
                      </a>
                      <a href="https://facebook.com" className="hover:text-blue-600 text-gray-600">
                        <FaFacebook className="text-2xl" />
                      </a>
                      <a href="https://linkedin.com" className="hover:text-blue-600 text-gray-600">
                        <FaLinkedin className="text-2xl" />
                      </a>
                      <a href="https://twitter.com" className="hover:text-blue-600 text-gray-600">
