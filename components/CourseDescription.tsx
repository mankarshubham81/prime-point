    ...
    <section id="courses" className="py-1 text-lg bg-white shadow-lg rounded">
      <div className="container mx-auto px-4 lg:px-20">
        ...
        <article className="p-8 mb-1 ">
          <h3 className="text-3xl font-semibold mb-6">Join Prime Point Academy - Best UI UX Design Course in Pune</h3>
          <p className="mb-4">
        ...
        <article className=" p-8 mb-1">
          <h3 className="text-3xl font-semibold mb-6">Why is Prime Point Academy the Best for SAP MM and SAP FICO Course in Pune?</h3>
        ...
        {/* MERN Stack Course */}
        <article className=" p-8 mb-1 ">
          <h3 className="text-3xl font-semibold mb-6">Join One of the Best MERN Stack Classes in Pune at Prime Point Academy</h3>
          <p className="mb-4">MERN Stack which is the fundamental technology for building the website. Our MERN stack course in Pune covers MongoDB, Express.js, React, and Node.js, giving students the ability to gain knowledge in developing highly-scalable, and high-quality web apps. Students can gain hands-on experience, work on live projects, and receive industry-relevant training with our MERN stack classes in Pune.</p>
          <p className="text-2xl font-semibold mb-4">
