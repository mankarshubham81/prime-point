...
export const metadata = {
  title: 'Courses - MyCodingCourses',
  description: 'Explore our comprehensive catalog of coding and design courses',
};
...
const coursesData = [
  ...
  },
  {
    ...
    image:
      'https://images.unsplash.com/photo-1580894742597-87bc8789db3d?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80',
    duration: '8 Weeks',
  ...
  },
  {
    ...
    description:
      'Master MongoDB, Express, React, and Node.js with a real-world e-commerce project.',
    slug: 'mern-stack',
    image:
